...
class InputData():
    ...
    def input_data_defender(self):
        ...
        print("Defense member data range: {}".format(self.defense_member_data_index_range))
        ...
        print("Defense nonmember data range: {}".format(self.defense_nonmember_data_index_range))
        ...
        print("y_train_user shape: {}".format(y_train_user.shape))
        ...
        print("y_nontrain_defender shape: {}".format(y_nontrain_defender.shape))
        ...
        print("y_train_defender shape: {}".format(y_train_defender.shape))
        print("x_train_defender shape: {}".format(x_train_defender.shape))
    ...
    def input_data_attacker_adv1(self):
        ...
        print("x_train_attacker.shape[0]:",x_train_attacker.shape[0])
    ...
    def input_data_attacker_evaluate(self):
        ...
        print("x_evaluate_attacker.shape[0]:",x_evaluate_attacker.shape[0])
